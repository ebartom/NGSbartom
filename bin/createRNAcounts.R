...
if (assembly == "hg38") {
    organism <- Hsapiens
    txdbfile <- "/projects/b1025/anno/Txdb/hsapiens_gene_ensembl_Ens78.txdb"
#    txdbfile <- "/projects/b1025/anno/Txdb/hsapiens_gene_ensembl_Ens72.txdb"
}
if (assembly == "hg19") {
    organism <- Hsapiens
...
if (assembly == "mm9") {
    organism <- Mmusculus
    txdbfile <- "/projects/b1025/anno/Txdb/mmusculus_gene_ensembl_Ens67.txdb"
}
if (assembly == "mm10") {
    organism <- Mmusculus
#    txdbfile <- "/projects/b1025/anno/Txdb/mmusculus_gene_ensembl_Ens75.txdb"
    txdbfile <- "/projects/b1025/anno/Txdb/mmusculus_gene_ensembl_Ens78.txdb"
}
if (assembly == "sacCer3") {
    organism <- Scerevisiae
    print("error! sacCer3 txdb not prepared!")
}
if (assembly == "dm3") {
    organism <- Dmelanogaster
    txdbfile <- "/projects/b1025/anno/Txdb/dmelanogaster_gene_ensembl_Ens78.txdb"
}
...
save(counts, file=file.path("counts.rda"))
write.table(counts, file=file.path("counts.txt"),sep="\t")
