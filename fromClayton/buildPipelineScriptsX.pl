e#!/software/activeperl/5.16/bin/perl -w
...
# Define references.
my (%bowtieIndex,%txIndex,%txdbfile,%bwaIndex,%gff,%exonbed);
...
$exonbed{"hg19"} = "/projects/b1025/anno/Ens/hg19.Ens_72/hg19.Ens_72.exons.bed";
$exonbed{"dm3"} = "/projects/b1025/anno/Ens/dm3.Ens_74/dm3.Ens_74.exons.bed";
$exonbed{"mm10"} = "/projects/b1025/anno/Ens/mm10.Ens_78/mm10.Ens_78.exons.bed";
$exonbed{"mm9"} = "/projects/b1025/anno/Ens/mm9.Ens_67/mm9.Ens_67.exons.bed";
$exonbed{"sacCer3"} = "/projects/b1025/anno/Ens/sacCer3.Ens_78/sacCer3.Ens_78.exons.bed";
$gff{"hg19"} = "/projects/b1025/anno/Ens/hg19.Ens_72/hg19.Ens_72.cuff.gtf";
$gff{"dm3"} = "/projects/b1025/anno/Ens/dm3.Ens_74/dm3.Ens_74.cuff.gtf";
$gff{"mm10"} = "/projects/b1025/anno/Ens/mm10.Ens_78/mm10.Ens_78.cuff.gtf";
$gff{"mm9"} = "/projects/b1025/anno/Ens/mm9.Ens_67/mm9.Ens_67.cuff.gtf";
$gff{"sacCer3"} = "/projects/b1025/anno/Ens/sacCer3.Ens_78/sacCer3.Ens_78.cuff.gtf";
...
#	    print SH "\nmv \$TMPDIR\/$project\_$sample\_tophatOut $outputDirectory\/$project\/Tophat_aln\/$sample\n";
		...
		print SH "module load bedtools/2.17.0\n";
	    	...
	    	print SH "module unload bedtools/2.17.0\n";
	    }	
	    print SH "date\n\n";
...
#	    print SH "Rscript $NGSbartom/tools/createRNAcounts.R --assembly=$reference{$project} --bamDir=$bamDirectory --numCores=$numProcessors\n";
	    ...
	    if ($htseq == 1) {
		print SH "mkdir $outputDirectory\/$project\/htseq_analysis\n";
	    	print SH "perl /projects/b1025/ckc/ETBpipeline/makeHTseqCountsTable.pl $bamDirectory\/ $gff{$reference{$project}} $bamDirectory\/\n";
	    	print SH "perl /projects/b1025/ckc/ETBpipeline/getHTseqRPKM.pl $bamDirectory\/htseq.all.counts.txt $bamDirectory\/\n";
	    }
	    if ($bedtools == 1) {
	    	print SH "mkdir $outputDirectory\/$project\/bedtools_analysis\n";
	    	print SH "perl /projects/b1025/ckc/ETBpipeline/makeBEDtoolsCountsTable.pl $bamDirectory\/ $bamDirectory\/\n";
	    	print SH "perl /projects/b1025/ckc/ETBpipeline/getBEDtoolsRPKM.pl $bamDirectory\/bedtools.all.counts.txt $bamDirectory\/\n";
	    }
	    print SH "date\n";
	    if ($comparisons ne ""){
		...
		if ($htseq == 1) {
		    print SH "Rscript /projects/b1025/ckc/ETBpipeline/runEdgeRrnaSeqforHTseqBEDtools.R --assembly=$reference{$project} --countFile=$bamDirectory\/htseq.all.counts.txt --rpkmFile=$bamDirectory\/htseq.all.rpkm.txt --comparisonFile=$comparisons --numCores=$numProcessors --outputDirectory=$outputDirectory\/$project\/htseq_analysis --runMDS=0\n";
		}
		if ($bedtools == 1) {
		    print SH "Rscript /projects/b1025/ckc/ETBpipeline/runEdgeRrnaSeqforHTseqBEDtools.R --assembly=$reference{$project} --countFile=$bamDirectory\/bedtools.all.counts.txt --rpkmFile=$bamDirectory\/bedtools.all.rpkm.txt --comparisonFile=$comparisons --numCores=$numProcessors --outputDirectory=$outputDirectory\/$project\/bedtools_analysis --runMDS=0\n";
		}
		...
		if ($htseq == 1) {
		    print SH "Rscript /projects/b1025/ckc/ETBpipeline/runEdgeRrnaSeqforHTseqBEDtools.R --assembly=$reference{$project} --countFile=$bamDirectory\/htseq.all.counts.txt --rpkmFile=$bamDirectory\/htseq.all.rpkm.txt --numCores=$numProcessors --outputDirectory=$outputDirectory\/$project\/htseq_analysis --runMDS=1\n";
		}
		if ($bedtools == 1) {
		    print SH "Rscript /projects/b1025/ckc/ETBpipeline/runEdgeRrnaSeqforHTseqBEDtools.R --assembly=$reference{$project} --countFile=$bamDirectory\/bedtools.all.counts.txt --rpkmFile=$bamDirectory\/bedtools.all.rpkm.txt --numCores=$numProcessors --outputDirectory=$outputDirectory\/$project\/bedtools_analysis --runMDS=1\n";
		}
		print SH "date\n";
		...
		if ($htseq == 1) {
			print SH "Rscript /projects/b1025/ckc/ETBpipeline/makeCorrelationPlotAllSamplesForHTseqBEDtools.R --countFile=$bamDirectory\/htseq.all.counts.txt --outputDirectory=$outputDirectory\/$project\/htseq_analysis\n";
		}
		if ($bedtools == 1) {
			print SH "Rscript /projects/b1025/ckc/ETBpipeline/makeCorrelationPlotAllSamplesForHTseqBEDtools.R --countFile=$bamDirectory\/bedtools.all.counts.txt --outputDirectory=$outputDirectory\/$project\/bedtools_analysis\n";
		}
		print SH "date\n";
		...
		while(<CMP>){
			...
			if ($htseq == 1) {
				print SH "Rscript $NGSbartom/tools/makeMAplot.R --degFile=$outputDirectory\/$project\/htseq_analysis\/$comp.edgeR.txt --adjp=0.01 --labelTop=1\n";
			}
			if ($bedtools == 1) {
				print SH "Rscript $NGSbartom/tools/makeMAplot.R --degFile=$outputDirectory\/$project\/bedtools_analysis\/$comp.edgeR.txt --adjp=0.01 --labelTop=1\n";
			}
			print SH "date\n";
...
#			print SH "Rscript $NGSbartom/tools/makeBigHeatmap.R --degFile=$outputDirectory\/$project\/analysis\/$comp.edgeR.txt --adjp=0.01 --countFile=$bamDirectory\/counts.rda\n";
			...
			if ($htseq == 1) {
			    print SH "Rscript $NGSbartom/tools/makeBigHeatmap.R --degFile=$outputDirectory\/$project\/htseq_analysis\/$comp.edgeR.txt --adjp=0.01 --countFile=$outputDirectory\/$project\/htseq_analysis\/allData.normCounts.txt\n";
			}
			if ($bedtools == 1) {
			    print SH "Rscript $NGSbartom/tools/makeBigHeatmap.R --degFile=$outputDirectory\/$project\/bedtools_analysis\/$comp.edgeR.txt --adjp=0.01 --countFile=$outputDirectory\/$project\/bedtools_analysis\/allData.normCounts.txt\n";
			}
			print SH "date\n";
			...
			if ($htseq == 1) {
				print SH "Rscript $NGSbartom/tools/runGOforDEG.R --degFile=$outputDirectory\/$project\/htseq_analysis\/$comp.edgeR.txt --adjp=0.01 --assembly=$reference{$project}\n";
			}
			if ($bedtools == 1) {
				print SH "Rscript $NGSbartom/tools/runGOforDEG.R --degFile=$outputDirectory\/$project\/bedtools_analysis\/$comp.edgeR.txt --adjp=0.01 --assembly=$reference{$project}\n";
			}
			print SH "date\n";
		    }
		}
		...
		if ($htseq == 1) {
			print SH "Rscript /projects/b1025/ckc/ETBpipeline/runEdgeRrnaSeqforHTseqBEDtools.R --assembly=$reference{$project} --countFile=$bamDirectory\/htseq.all.counts.txt --rpkmFile=$bamDirectory\/bedtools.all.rpkm.txt --numCores=$numProcessors --outputDirectory=$outputDirectory\/$project\/htseq_analysis --runMDS=1\n";
		}
		if ($bedtools == 1) {
			print SH "Rscript /projects/b1025/ckc/ETBpipeline/runEdgeRrnaSeqforHTseqBEDtools.R --assembly=$reference{$project} --countFile=$bamDirectory\/bedtools.all.counts.txt --rpkmFile=$bamDirectory\/bedtools.all.rpkm.txt --numCores=$numProcessors --outputDirectory=$outputDirectory\/$project\/bedtools_analysis --runMDS=1\n";
		}
