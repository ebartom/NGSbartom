...
Welcome to the JavaMail API 1.2 release!  This release includes
...
--------
    ...
    docs/javadocs/	The JavaMail API 1.2 javadocs

    docs/sundocs/	The javadocs for the Sun protocol provider-specific APIs
